...
// import { fetchJobRole, fetchDesignation , fetchDepartment} from '@/redux/jdManagemenet/jdManagemnetSlice'
...
//   const { jobRoleData, designationData, departmentData } = useAppSelector(state => state.jdManagementReducer) // Assuming jdManagementSlice has these properties
...
//     console.log('AddNewJDFormik.values', AddNewJDFormik.values)
...
//       .unwrap()
//       .then(response => {
//         console.log('Job roles fetched successfully:', response)

//         // Optionally, you can update formik values or organization chart based on response
//         // Example: if in edit mode, populate form with fetched data
//         if (mode === 'edit' && response.data) {
//           // Assuming response.data contains the job role details
//           const jdData = response.data[0] // Adjust based on your API response structure

//           AddNewJDFormik.setValues({
//             ...AddNewJDFormik.values,
//             roleSpecification: [
//               {
//                 roleTitle: jdData.roleTitle || '',
//                 employeeInterviewed: jdData.employeeInterviewed || '',
//                 reportsTo: jdData.reportsTo || '',
//                 companyName: jdData.companyName || '',
//                 functionOrDepartment: jdData.functionOrDepartment || '',
//                 writtenBy: jdData.writtenBy || '',
//                 approvedByJobholder: jdData.approvedByJobholder || '',
//                 approvedBySuperior: jdData.approvedBySuperior || '',
//                 dateWritten: jdData.dateWritten || ''
//               }
//             ],
//             roleSummary: jdData.roleSummary || '',
//             keyResponsibilities: jdData.keyResponsibilities || [{ title: '', description: '' }],
//             keyChallenges: jdData.keyChallenges || '',
//             keyDecisions: jdData.keyDecisions || '',
//             keyInteractions: jdData.keyInteractions || [{ internalStakeholders: '', externalStakeholders: '' }],
//             keyRoleDimensions: jdData.keyRoleDimensions || [
//               { portfolioSize: '', geographicalCoverage: '', teamSize: '', totalTeamSize: '' }
//             ],
//             skillsAndAttributesType: jdData.skillsAndAttributesType || 'description_only',
//             skillsAndAttributesDetails: jdData.skillsAndAttributesDetails || [
//               {
//                 factor: '',
//                 competency: [{ value: '' }],
//                 definition: [{ value: '' }],
...
//               }
//             ],
//             educationAndExperience: jdData.educationAndExperience || [
//               { minimumQualification: '', experienceDescription: '' }
//             ]
//           })

//           if (jdData.organizationChart) {
//             setOrganizationChart(jdData.organizationChart)
//             setIsChartVisible(true)
//           }
//         }
//       })
...
//                           AddNewJDFormik.setFieldValue(`roleSpecification[${index}].roleTitle`, newValue || '')
//                         }}
//                         renderInput={params => (
//                           <TextField
//                             {...params}
...
//                     <FormControl fullWidth margin='normal'>
//                       <label
//                         htmlFor={`roleSpecification[${index}].reportsTo`}
...
//                         onChange={(event, newValue) => {
//                           AddNewJDFormik.setFieldValue(`roleSpecification[${index}].reportsTo`, newValue || '')
//                         }}
//                         freeSolo
//                         renderInput={params => (
//                           <TextField
...
//                             }
//                             placeholder='Select or enter reporting to'
//                           />
//                         )}
//                       />
//                     </FormControl>
...
//                     <FormControl fullWidth margin='normal'>
//                       <label
//                         htmlFor={`roleSpecification[${index}].functionOrDepartment`}
//                         className='block text-sm font-medium text-gray-700'
//                       >
//                         Function/Department *
//                       </label>
...
//                             `roleSpecification[${index}].functionOrDepartment`,
//                             newValue || ''
//                           )
//                         }}
//                         freeSolo
...
//                             }
//                             placeholder='Select or enter function/department'
//                           />
//                         )}
//                       />
//                     </FormControl>
