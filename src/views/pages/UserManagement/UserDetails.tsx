...
import { Box, Typography, CircularProgress, Card, Grid, Chip, Divider, Avatar } from '@mui/material'
      ...
      <Box sx={{ mt: 4 }}>
        <Card sx={{ p: 4, borderRadius: '14px' }}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Typography sx={{ mb: 1, fontWeight: 600 }}>Inherited Permissions:</Typography>
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
