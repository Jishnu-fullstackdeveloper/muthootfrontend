...
const series = [{ data: [20, 15] }] // Example data: [Applied, Shortlisted]

const ShortlistedCandidateChart = () => {
  // Hooks
  ...
  const options: ApexOptions = {
    ...
    xaxis: {
      categories: ['A', 'S'], // Updated categories for applied and shortlisted
      axisTicks: { show: true },
      ...
      <CardContent className='flex justify-between gap-2'>
        <div className='flex flex-col justify-between'>
          <div className='flex flex-col gap-y-2'>
            <Typography variant='h5'>Shortlisted Candidates</Typography>
          </div>
          <div className='flex flex-col gap-y-2 items-start'>
            <Typography variant='h3'>Total: 35</Typography> {/* Example total count */}
            <Chip variant='tonal' size='small' color='success' label='+8.5%' />
          </div>
        </div>
...
export default ShortlistedCandidateChart
