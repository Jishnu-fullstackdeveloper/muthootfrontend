    ...
    <>
      <Card
        sx={{
          mb: 4,
          position: 'sticky',
          top: 60, // Sticks the card at the top of the viewport
              ...
              <Step key={label} {...stepProps}>
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Typography sx={{ ml: 5 }}>{label}</Typography>
                  </Box>
                </StepLabel>
              </Step>
            )
      ...
      <form onSubmit={AddNewJDFormik.handleSubmit} className='p-6 bg-white shadow-md rounded'>
        <h1 className='text-2xl font-bold text-gray-800 mb-4'>{mode === 'add' ? 'Add Job Description' : 'Edit JD'}</h1>
        ...
        <Box sx={{ width: '50%', mb: 5 }}>
          <FormControl fullWidth margin='normal'>
            ...
            <DynamicSelect
              ...
              // onFocus={() => AddNewJDFormik.setFieldTouched('reportingTo', true)}
              error={
                AddNewJDFormik.touched.skillsAndAttributesType && Boolean(AddNewJDFormik.errors.skillsAndAttributesType)
              }
              helperText={
